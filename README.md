...
Assets, Work Flow, and Dev Journal for Cloud Resume Deployment on Azure Infrastructure

This repository contains infrastructure code for deploying my cloud resume project on Azure using Terraform. The configuration makes use of various Azure resources in support of a serverless and highly available web application.
